...
import adminWardRouter from "./routes/admin-ward";
import adminSajiloTemplatesRouter from "./routes/admin-sajilo-templates";
...
app.use("/api/admin", adminWardRouter);
app.use("/api/admin", adminSajiloTemplatesRouter);
